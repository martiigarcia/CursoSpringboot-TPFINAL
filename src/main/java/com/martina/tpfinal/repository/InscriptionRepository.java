...
public interface InscriptionRepository extends JpaRepository<Inscription, Long> {
    ...
    //E -> D
    List<Inscription> findByStatusIn(List<String> statuses); // Consulta derivada para buscar Inscription con status 'RECHAZADA' o 'PENDIENTE'
